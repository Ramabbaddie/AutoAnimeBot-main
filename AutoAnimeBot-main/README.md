...
<h2 align="center"><b>Automates The Process Of Managing Your Anime Channels</b></h2>
...
* Powered By Consumet API and GogoAnime
...
* `CONSUMET_API` - URL of your Consumet API (e.g. `https://your-consumet.onrender.com`)
